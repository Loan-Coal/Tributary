...
- **W6c.1+W6c.2+W6c.3 done**: WHT silent-zero bug fixed; `EU_MEMBER_JURISDICTIONS` moved to `common/`; Zinsschranke EBITDA clamp fixed; 2 new regression tests; 218 tests green. Next: W6c.4 (conflict_id collision).
