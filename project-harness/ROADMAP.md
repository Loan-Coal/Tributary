...
- **W6c.1–W6c.4 done**: WHT silent-zero bug; EU_MEMBER_JURISDICTIONS moved; Zinsschranke clamp; conflict_id collision fixed; 219 tests green. Next: W6c.5 (runner unguarded [0] index).
